...
<body>
    ...
    <div class="carousel-inner" style="display: flex; transition: transform 0.5s ease; width: 100%;">
                <img src="https://www.redocean.co.uk/image/cache/products/27852/image03_2000-1500x1500.jpg" alt="Luxury Caravan" style="flex: 0 0 100%; height: 50vw; max-height: 400px; object-fit: cover;">
